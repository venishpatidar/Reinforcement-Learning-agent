...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        Q_value_with_actions = [(self.getQValue(state,action),action) for action in legalActions]
        max_Q_value = max(Q_value_with_actions,key=lambda x: x[0])
        # Breaking tie
        max_actions = [action for Q_value,action in Q_value_with_actions if Q_value == max_Q_value[0]]
