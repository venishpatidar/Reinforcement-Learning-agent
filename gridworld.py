...
if __name__ == '__main__':
    ...
    import valueIterationAgents, qlearningAgents, reinforceAgents
    a = None
    if opts.agent == 'value':
        a = valueIterationAgents.ValueIterationAgent(mdp, opts.discount, opts.iters)
    # Modifying to add reinforce agent
    elif opts.agent == 'reinforce':
        a = reinforceAgents.ReinforceAgent(mdp)
    elif opts.agent == 'q':
    ...
    if not opts.quiet:
        if opts.manual and opts.agent == None:
            ...
            if opts.agent in ('random', 'value', 'asynchvalue', 'priosweepvalue', 'reinforce'):
